...
I can now begin to merge the datasets together using the `left_join` function, starting with the *bakers* and *bakes* datasets. I am merging the datasets based off the two variables they have in common, *series* and *first_name*.  
