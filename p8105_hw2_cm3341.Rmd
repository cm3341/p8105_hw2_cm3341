...
This problem uses trash wheel datasets for three different trash wheel garbage collector vehicles (Mr. Trash Wheel, Professor Trashwheel, and Gwynnda Trash Wheel). These machines clean debris from various harbors. 
